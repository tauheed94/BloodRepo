...
// Looping through results
	...
	if($valid) { 
		...
		echo "<script>document.location='Req.html'</script>SUCCESSFULLY LOGIN TO USER PROFILE PAGE..."; 
	} else { 
		echo "<script>document.location='Req.html'</script>SORRY... YOU ENTERD WRONG ID AND PASSWORD... PLEASE RETRY..."; 
	}
}
